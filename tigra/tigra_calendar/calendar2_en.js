...
// Note: Script consists of two files: calendar?.js and calendar_en.html
...
function cal_popup2 (str_datetime) {
	...
	var obj_calwindow = window.open(
		'/vendorsrc/tigra/tigra_calendar/calendar_en.html?id=' + this.id + '&s=' + this.dt_selected.valueOf() + '&c=' + this.dt_current.valueOf(),
